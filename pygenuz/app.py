...
from .middelware import Middleware
from .response import Response

class PyGenUz:
    def __init__(self, templates_dir="temps", static_dir="static"):
        self.routes = dict()
    ...
    def wsgi_app(self, environ, start_response):
        ...
        respone = self.handle_request(request)
        ...
        if handler_data is not None:
            ...
            if inspect.isclass(handler):
                ...
                if request.method.lower() not in allowed_methods:
                    response.status_code = 405
                    response.text = f"Method Not Allowed"
                    return response
